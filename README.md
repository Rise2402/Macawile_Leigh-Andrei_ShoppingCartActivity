...
What I changed/improved after using AI

After using AI, I improved several aspects of my project by making the program structure more organized and easier to understand through proper use of classes like Product and CartItem. I learned how to correctly store and access objects within another class, which helped me fix my confusion about handling product data. I also resolved the issue of duplicate items in the cart by updating the logic to check if an item already exists before adding it, allowing the quantity to increase instead of creating multiple entries. In addition, I improved my input validation by properly applying int.TryParse(), making the program more reliable when handling user input. Lastly, I enhanced the menu and receipt layout to make the output more clear, organized, and similar to a real shopping cart system.
